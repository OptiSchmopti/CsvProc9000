...
internal sealed class SettingsManager : ISettingsManager
{
    ...
    private const string IsoDateFormat = "yyyy-MM-dd_HH_mm_ss";
    ...
    private static void MakeBackup(string pathToSettingsFile)
    {
        ...
        var backupFileName = Path.Combine(fileDirectory, $"appsettings-BACKUP-{DateTime.Now.ToString(IsoDateFormat)}.json");
